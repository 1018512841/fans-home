/**
 * Created by fanxiaopeng on 2014/06/28.
 */
fans_home.tourist_post = function () {
    return{
        ...
        init_fans_tourist_detail_screen: function () {
            ...
            $(".item_happy").click(function () {
                if ($(".detail_tourist").css("display") == "none" && $('#fans-map').data("init_vectorMap") != true) {
                    var options = {
                        url: "tourist_posts/tourist_city",
                        type: "POST",
                        data: "",
                        success: function (data) {
                            fans_home.tourist_post.init_fans_map(data);
                            $('#fans-map').data("init_vectorMap", true);
                        }
                    };
                    $.ajax(options);
                }
